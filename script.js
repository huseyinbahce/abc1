const uiText = {
  ...
  tr: {
    ...
    aboutBody:
      'Konveyör sistemleri doğru montaj ve planlı bakım ile en iyi performanslarını verir. Sahada karşılaşılan birçok problem, yanlış kullanım veya kök neden analizi yapılmadan yapılan müdahaleler nedeniyle tekrar meydana gelir. Bu kılavuz, yaşadığınız problemleri olası kök nedenleriyle eşleştirir ve uygulanabilir çözüm adımlarını sunar.',
    aboutAria: 'About this guide',
    legendProblem: 'Problem',
